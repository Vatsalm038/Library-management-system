...
public class IssueBook extends JFrame implements ActionListener {
	...
	public IssueBook() {
		...
		l1.setForeground(new Color(225, 225, 225));
		l1.setBounds(47, 63, 100, 23);
		contentPane.add(l1);

		JLabel l2 = new JLabel("Name");
		l2.setForeground(new Color(225, 225, 225));
		l2.setFont(new Font("Tahoma", Font.BOLD, 14));
		l2.setBounds(47, 97, 100, 23);
		contentPane.add(l2);

		JLabel l3 = new JLabel("ISBN");
		l3.setForeground(new Color(225, 225, 225));
		l3.setFont(new Font("Tahoma", Font.BOLD, 14));
		l3.setBounds(47, 131, 100, 23);
		contentPane.add(l3);

		JLabel l4 = new JLabel("Publisher");
		l4.setForeground(new Color(225, 225, 225));
		...
		l6.setForeground(new Color(225, 225, 225));
		l6.setFont(new Font("Tahoma", Font.BOLD, 14));
		l6.setBounds(47, 233, 100, 23);
		contentPane.add(l6);

		JLabel l7 = new JLabel("Pages");
		l7.setForeground(new Color(225, 225, 225));
		...
		panel_1.setBorder(new TitledBorder(new LineBorder(new Color(220, 220, 220), 2, true)));
		panel_1.setForeground(new Color(0, 100, 0));
		panel_1.setBounds(360, 38, 378, 372);
		panel_1.setBackground(new Color(34, 35, 36));
		contentPane.add(panel_1);

		JLabel l15 = new JLabel(" Date of Issue :");
		l15.setForeground(new Color(225, 225, 225));
